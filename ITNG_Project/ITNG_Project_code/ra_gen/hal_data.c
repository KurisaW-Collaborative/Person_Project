...
const spi_extended_cfg_t g_spi1_ext_cfg =
{
    ...
    .spck_div            = {
        /* Actual calculated bitrate: 114679. */ .spbr = 217, .brdv = 1
    },
...
iic_master_instance_ctrl_t g_i2c0_ctrl;
const iic_master_extended_cfg_t g_i2c0_extend =
{
    .timeout_mode             = IIC_MASTER_TIMEOUT_MODE_SHORT,
    .timeout_scl_low          = IIC_MASTER_TIMEOUT_SCL_LOW_ENABLED,
    /* Actual calculated bitrate: 396825. Actual calculated duty cycle: 51%. */ .clock_settings.brl_value = 25, .clock_settings.brh_value = 26, .clock_settings.cks_value = 1,
};
